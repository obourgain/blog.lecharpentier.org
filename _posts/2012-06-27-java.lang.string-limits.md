...
Du coup, lorsque l'on arrive pour afficher la valeur, on se retrouve
avec une `OutOfMemoryError`. Pas super sympathique..
...
donné la bonne idée de passer par un OutputStream ainsi, je ne stocke
